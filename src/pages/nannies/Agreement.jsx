        ...
        <>
            <div className="nanny-agreement">
                ...
                <div className="centered-container"> 
                    <TextField fullWidth={false} label="Σμφωνητικό" type="text" className="text-agreement1" value="Θέλω να έρθω σε συμφωνία με τους:" disabled />
                </div> 
                <div className="content flex-grow-1 d-flex align-items-center justify-content-center"> 
                    <Row className="align-items-start justify-content-center g-5 m-0 w-100">
                       <Col
                        ...
                        >
                            <TextField fullWidth={false} label="Ονοματεπώνυμο κηδεμόνα 1" type="text" className="text-agreement2" value="Αποστόλης Γραμματόπουλος" disabled />
                        </Col>
                        <Col
                            md={6}
                            xs={12}
                            className="d-flex flex-column align-items-center justify-content-center text-center"
                        >
                            <TextField fullWidth={false} label="Ονοματεπώνυμο κηδεμόνα 2" type="text" className="text-agreement2" value="Ελευθερία Ελευθερίου" disabled />
                        </Col>
                    </Row> 
                </div>              
                <div className="content flex-grow-1 d-flex align-items-center justify-content-center"> 
                ...
                <span style={{ marginRight: '10px' }}>Επιβεβαιώνω ότι έχουμε έρθει σε συμφωνία με τους προαναφερθέντες στο ωράριο που έχει δηλωθεί</span>
                <input 
                    type="checkbox" 
                    checked={isChecked} 
