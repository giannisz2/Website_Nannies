...
import NannyImage from '../../assets/images/nanny_cropped.jpg'
...
export default function SelectionCriteria() {
    ...
    return(<div id="SelectionCriteria">
                ...
                <div className='P'>
                    <Favorite id="icons"/>
                    <div>
                        <p className='text1'>Αγαπάς τα Παιδιά;</p>
                ...
                <div className='P'>
                    ...
                    <div>
                        <p className='text1'>Κλείσε την συμφωνία σου</p>
                ...
                <div className='P'>
                    <WalletIcon id="icons"/>
                    <div>
                        <p className='text1'>Πώς θα παίρνεις την αμοιβή σου</p>
